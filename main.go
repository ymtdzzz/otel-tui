...
func (c *collectorCommand) preRunE(cmd *cobra.Command, args []string) error { //nolint:unused
...
func (c *collectorCommand) runE(cmd *cobra.Command, args []string) error { //nolint:unused
